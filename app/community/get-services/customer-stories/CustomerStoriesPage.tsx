  ...
  return (
    <main className="overflow-hidden bg-[linear-gradient(180deg,_#fff_0%,_#f0f9ff_18%,_#ffffff_100%)] text-slate-800">
      ...
      <section className="relative isolate" ref={heroRef}>
        <div className="absolute inset-x-0 top-0 -z-10 h-[38rem] bg-[radial-gradient(circle_at_15%_12%,rgba(2,132,199,0.12),transparent_28%),radial-gradient(circle_at_85%_8%,rgba(125,211,252,0.11),transparent_26%),linear-gradient(180deg,rgba(255,255,255,1)_0%,rgba(240,249,255,1)_30%,rgba(255,255,255,1)_100%)]" />
        ...
        <div className="mx-auto grid max-w-7xl gap-16 px-4 py-14 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-28">
          ...
          >
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-3">
                ...
                >
                  use Adon ERP to
                  <br />
                  <span className="text-sky-600">scale</span>
                </h1>
              </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href="#"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-6 py-3 text-sm font-semibold text-slate-700 shadow-sm transition-colors duration-300 hover:border-sky-300 hover:text-sky-600"
              >
            ...
            {/* Stats strip */}
            <div className="grid grid-cols-4 gap-3 rounded-2xl border border-sky-100 bg-white/80 p-5 backdrop-blur-sm shadow-sm">
              {STATS.map((s) => (
          ...
          >
            <div className="absolute -top-6 right-8 h-28 w-28 rounded-full bg-sky-100 blur-3xl" />
            <div className="absolute -bottom-10 left-4 h-36 w-36 rounded-full bg-cyan-100 blur-3xl" />
            ...
            <div className="w-full overflow-hidden rounded-[2.5rem] border-8 border-white bg-white shadow-[0_40px_100px_rgba(15,23,42,0.1)]">
              ...
              <div className="p-5 space-y-4">
                {/* Video placeholder */}
                <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-sky-100 to-cyan-100 aspect-video flex items-center justify-center">
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_40%,rgba(2,132,199,0.15),transparent_60%)]" />
                  <div className="relative flex h-14 w-14 items-center justify-center rounded-full bg-sky-600 shadow-xl shadow-sky-500/30">
                    <Play className="h-6 w-6 text-white ml-0.5" />
                  </div>
                  <div className="absolute bottom-3 left-3 flex items-center gap-1.5 rounded-full bg-white/70 backdrop-blur-sm px-2.5 py-1">
                    <span className="text-[10px] font-semibold text-slate-700">5 min</span>
                  </div>
                </div>
                <div>
                  <p className="text-xs font-bold uppercase tracking-widest text-sky-500 mb-1">Featured Story</p>
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    ...
                    <span className="text-xs text-slate-500">Rajesh Menon — Operations Director</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {FEATURES.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-sky-200 hover:shadow-xl"
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br opacity-[0.030] transition-opacity duration-300 group-hover:opacity-[0.06]`}
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(2,132,199,0.04), rgba(125,211,252,0.02))",
                  }}
                />
                <div className="relative">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-sky-50 text-sky-600 shadow-sm">
          ...
          {INDUSTRIES.map((ind, index) => {
            ...
            return (
              <motion.div
                ...
                className="group flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-sky-200 hover:shadow-lg"
              >
                <div
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500">{ind.count}</p>
                </div>
                <ArrowRight className="h-4 w-4 text-slate-300 group-hover:text-sky-500 transition-colors shrink-0" />
              </motion.div>
            );
          })}
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          {STORIES.map((story, index) => (
            <motion.div
              ...
              viewport={{ once: true, amount: 0.15 }}
              className="group relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm hover:shadow-xl transition-all duration-300"
            >
              <div className="absolute -top-14 -right-14 h-48 w-48 rounded-full bg-sky-100/30 blur-3xl" />
              <div className="relative space-y-5">
                {/* Header */}
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      className={`flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br text-sm font-black text-white shadow-md shadow-sky-500/10`}
                    >
                      {story.avatar}
                    </div>
                    <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {story.results.map((r) => (
                    <span
                      key={r}
                      className="inline-flex items-center gap-1.5 rounded-full bg-sky-50 px-3 py-1 text-xs font-semibold text-sky-700 ring-1 ring-sky-100"
                    >
          ...
          {[
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true, amount: 0.2 }}
                className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm text-center"
              >
                ...
                <p className="text-3xl font-black text-sky-600">{item.stat}</p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          {[
            ...
            >
              <div className="absolute -top-14 -right-14 h-48 w-48 rounded-full bg-sky-100/40 blur-3xl" />
              <div className="relative space-y-5">
                ...
                <div className="flex items-center gap-4 border-t border-slate-100 pt-5">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-sky-500 to-blue-600 text-sm font-black text-white">
                    {t.avatar}
                  </div>
                  <div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-slate-900 via-sky-900 to-blue-900 px-6 py-16 text-center shadow-[0_50px_130px_rgba(15,23,42,0.22)] sm:px-10 sm:py-20"
        >
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute -top-24 -right-24 h-60 w-60 rounded-full bg-sky-500/25 blur-3xl" />
          ...
          <div className="relative space-y-6">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <a
                href="#"
                className="inline-flex items-center gap-2 rounded-xl bg-white px-7 py-3.5 text-sm font-semibold text-sky-900 shadow-xl transition-all hover:shadow-2xl hover:-translate-y-0.5"
              >
                <Sparkles className="h-4 w-4" />
                Submit your story
              </a>
            ...
            <p className="mt-6 text-sm text-sky-200/60">
