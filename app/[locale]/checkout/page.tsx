...
import { CreditCard, ChevronLeft, Truck, Shield } from "lucide-react";
...
export default function CheckoutPage() {
  ...
  const content: CheckoutContent = {
    ...
    subtitle: t("checkoutPage.subtitle"),
    billingShipping: t("checkoutPage.billingShipping"),
    fullName: t("checkoutPage.fullName"),
    phone: t("checkoutPage.phone"),
    email: t("checkoutPage.email"),
    district: t("checkoutPage.district"),
    areaCity: t("checkoutPage.areaCity"),
    deliveryAddress: t("checkoutPage.deliveryAddress"),
    streetAddress: t("checkoutPage.streetAddress"),
    createAccount: t("checkoutPage.createAccount"),
    orderNotes: t("checkoutPage.orderNotes"),
    orderNotesPlaceholder: t("checkoutPage.orderNotesPlaceholder"),
    yourOrder: t("checkoutPage.yourOrder"),
    items: t("checkoutPage.items"),
    shipping: t("checkoutPage.shipping"),
    free: t("checkoutPage.free"),
    total: t("checkoutPage.total"),
    priceDetails: t("checkoutPage.priceDetails"),
    billingCycleLabel: t("checkoutPage.billingCycleLabel"),
    cashOnDelivery: t("checkoutPage.cashOnDelivery"),
    cashOnDeliveryDesc: t("checkoutPage.cashOnDeliveryDesc"),
    sslcommerz: t("checkoutPage.sslcommerz"),
    sslcommerzDesc: t("checkoutPage.sslcommerzDesc"),
    bkash: t("checkoutPage.bkash"),
    bkashDesc: t("checkoutPage.bkashDesc"),
    termsAndConditions: t("checkoutPage.termsAndConditions"),
    continueShopping: t("checkoutPage.continueShopping"),
    placeOrder: t("checkoutPage.placeOrder"),
    backButton: t("checkoutPage.backButton"),
    orderSummary: t("checkoutPage.orderSummary"),
    perMonth: t("checkoutPage.perMonth"),
    securePaymentText: t("checkoutPage.securePaymentText"),
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          >
            ← {isBengali ? "প্ল্যানে ফিরুন" : "Back to plans"}
          </button>
        </div>
      </div>
    );
  ...
  const formatBillingCycle = (cycle: BillingCycle) => {
    const cycleMap: Record<BillingCycle, string> = {
      monthly: isBengali ? "মাসিক" : "Monthly",
      quarterly: isBengali ? "ত্রৈমাসিক" : "Quarterly",
      semiannual: isBengali ? "অর্ধবার্ষিক" : "Semiannual",
      yearly: isBengali ? "বার্ষিক" : "Yearly",
    };
          ...
          <div className="sticky top-6 h-fit rounded-2xl border border-white/80 bg-white/95 p-6 shadow-2xl shadow-slate-900/10 backdrop-blur dark:border-slate-700 dark:bg-slate-900/95">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400">
                    {planData.userCount} {isBengali ? "ব্যবহারকারী" : "users"} •{" "}
                    {formatBillingCycle(planData.billingCycle)}
                  </p>
                </div>
              </div>
              <div className="text-right">
                <p className="font-bold text-slate-900 dark:text-white">
                  {formatPrice(planData.monthlyPrice)}
                </p>
            ...
            <div className="mt-6 space-y-3 border-b border-slate-200 pb-4 dark:border-slate-700">
              ...
              {planData.savings > 0 && (
                <div className="flex justify-between text-sm">
                  <span className="text-slate-600 dark:text-slate-400">
                    {content.billingCycleLabel} {isBengali ? "ছাড়" : "savings"}
                  </span>
                  <span className="font-medium text-emerald-600 dark:text-emerald-400">
                    -{formatPrice(planData.savings)}
                  </span>
                </div>
              )}
              <div className="flex justify-between text-sm">
