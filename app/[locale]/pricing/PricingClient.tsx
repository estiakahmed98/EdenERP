                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <h3 className="mt-1 text-2xl font-bold">
                          {t("hero.preview.currentPlanName")}
                        </h3>
                      </div>
            ...
            return (
              <div
                ...
                className={`group relative rounded-[2.2rem] transition-all duration-300 ${
                  plan.highlighted ? "lg:-mt-5 lg:mb-5" : "hover:-translate-y-1"
                }`}
              >
                {plan.highlighted && (
                ...
                <div
                  className={`relative flex h-full flex-col rounded-[2.2rem] border bg-white p-7 shadow-sm transition-all duration-300 group-hover:shadow-2xl dark:border-slate-800 dark:bg-slate-950 ${
                    plan.highlighted
            ...
            <table className="w-full min-w-[820px] text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-900/40">
                  ...
                  <th className="px-6 py-5 text-left font-bold text-slate-950 dark:text-slate-100">
                    {t("comparisonSection.headers.starter")}
                  </th>
                  <th className="px-6 py-5 text-left font-bold text-primary">
                    {t("comparisonSection.headers.professional")}
                  </th>
                  <th className="px-6 py-5 text-left font-bold text-slate-950 dark:text-slate-100">
                    {t("comparisonSection.headers.enterprise")}
                  </th>
                </tr>
              </thead>
