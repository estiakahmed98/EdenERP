...
const features = [
  {
    ...
    description:
      "Pre-configured for 180+ countries with local tax requirements",
...
const testimonials = [
  {
    ...
    content:
      "Adon ERP transformed our invoicing workflow. We've reduced payment collection time by 60% and eliminated manual data entry entirely.",
    rating: 5,
  ...
  },
  {
    ...
    content:
      "The automated reconciliation feature alone saved us 20+ hours per month. Best invoicing platform we've ever used.",
    rating: 5,
            ...
            <div className="max-w-xl space-y-8">
              ...
              <div className="space-y-5">
                ...
                <p className="max-w-lg text-lg leading-relaxed text-slate-600 dark:text-slate-300">
                  Automate your entire billing workflow — from creation to
                  payment. Save hours every week with smart templates,
                  auto-reminders, and instant reconciliation.
                </p>
              </div>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          >
            <SectionEyebrow
              ...
              label="One-click billing"
            />
            <ScriptHeading className="mt-4 text-3xl sm:text-4xl">
              Click. Invoice sent.
            </ScriptHeading>
            <p className="mt-4 text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
              Send professional invoices in seconds. Our intelligent system
              automates email delivery, payment reminders, and PDF generation —
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          >
            ...
            />
            <ScriptHeading className="mt-4 text-3xl sm:text-4xl">
              Your invoices in your{" "}
              <span className="text-emerald-600 dark:text-emerald-400">
                pocket
              </span>
            </ScriptHeading>
            <p className="mt-4 text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
              Manage your entire invoicing workflow from anywhere. Create, send,
              and track invoices on the go with our native mobile apps.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-4 text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
              Accept payments from anywhere in the world. Seamless integration
              with major payment gateways, automatic reconciliation, and
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-4 text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
              Never chase payments again. Smart bank synchronization combined
              with automated follow-ups ensures you get paid faster.
            </p>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-slate-900 via-emerald-900 to-cyan-900 px-6 py-16 text-center shadow-2xl sm:px-10">
          ...
          <div className="relative">
            ...
            <p className="mt-4 text-lg text-emerald-100 max-w-2xl mx-auto">
              Join thousands of businesses already saving hours every week with
