...
const recentTransactions = [
  { name: "Acme Corp", amount: "$3,500.00", status: "cleared", date: "Today", type: "payment" },
  { name: "TechStart Inc", amount: "$1,200.00", status: "pending", date: "Yesterday", type: "payment" },
  { name: "Global Supplies", amount: "$890.00", status: "cleared", date: "3 days ago", type: "expense" },
  { name: "Design Studio", amount: "$2,450.00", status: "cleared", date: "5 days ago", type: "payment" },
  { name: "Office Depot", amount: "$320.00", status: "pending", date: "Yesterday", type: "expense" },
];
    ...
    <main className="overflow-hidden bg-white text-slate-800 dark:bg-slate-950 dark:text-slate-100">
        ...
        <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-24">
          <div className="grid gap-16 lg:grid-cols-[1fr_1fr] lg:gap-12">
            ...
            <div className="max-w-xl space-y-8">
              <SectionEyebrow icon={<Calculator className="h-4 w-4" />} label="Intelligent Accounting" />
              
              <div className="space-y-5">
                <h1 className="text-5xl font-semibold leading-tight tracking-tight text-slate-900 sm:text-6xl lg:text-7xl dark:text-slate-100">
                  Accounting made
                  <br />
                ...
                <p className="max-w-lg text-lg leading-relaxed text-slate-600">
                  AI-native accounting platform for all your financial operations — from reconciliation
                  and expenses to tax returns and real-time reporting. Fast, complete, and simple.
                </p>
              </div>
                ...
                <div className="bg-linear-to-r from-emerald-600 to-cyan-600 px-5 py-3">
                  <div className="flex items-center justify-between text-white">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold">Accounting Dashboard</span>
                    </div>
                ...
                <div className="p-5">
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <div className="bg-slate-50 rounded-xl p-4">
                      <div className="flex justify-between items-start mb-3">
                        <p className="text-xs text-slate-500">Customer Invoices</p>
                        <div className="flex gap-1">
                          <span className="text-xs bg-red-100 text-red-600 px-2 py-0.5 rounded">5 Unpaid</span>
                          <span className="text-xs bg-yellow-100 text-yellow-600 px-2 py-0.5 rounded">3 Late</span>
                        </div>
                      </div>
                      <div className="space-y-1">
                        ...
                        <div className="flex justify-between text-sm">
                          <span>Late</span>
                          <span className="font-semibold text-red-600">$92,750.00</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-slate-50 rounded-xl p-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex justify-between text-sm">
                          <span>Late</span>
                          <span className="font-semibold text-red-600">$622.27</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 bg-linear-to-r from-emerald-50 to-cyan-50 rounded-xl p-4">
                    <div className="text-center">
                      ...
                      <p className="text-2xl font-bold text-slate-900">$9,944.87</p>
                      <div className="grid grid-cols-3 gap-2 mt-3 text-xs">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-emerald-600">+$8,578.50</p>
                        </div>
                        <div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <SectionEyebrow icon={<TrendingUp className="h-4 w-4" />} label="Lightning fast" />
            ...
            <div className="mt-6 space-y-4">
              {[
                ...
                { icon: Zap, value: "90ms", label: "Processing speed", color: "cyan" },
                { icon: TrendingUp, value: "3x", label: "Faster month-end close", color: "purple" },
              ].map((item, idx) => (
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="border-t pt-3">
                  <div className="flex justify-between text-sm">
                    <span className="text-slate-600">Office Design Software</span>
                    <span>$10.00</span>
                  </div>
                  <div className="flex justify-between text-sm mt-2">
                    <span className="text-slate-600">Office Chair (x5)</span>
                    <span>$20.00</span>
                  </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 bg-slate-50/50 rounded-3xl my-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
              <div className="bg-slate-50 border-b px-5 py-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium">Smart OCR Processing</span>
                </div>
              </div>
              <div className="p-5 space-y-3">
                <div className="flex items-center gap-3 p-3 bg-emerald-50 rounded-xl">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-slate-900">Invoice scanned</p>
                    <p className="text-xs text-slate-500">98% recognition rate</p>
                  </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-cyan-50 rounded-xl">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-slate-900">AI processing</p>
                    <p className="text-xs text-slate-500">Auto-extracting data</p>
                  </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-emerald-50 rounded-xl">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-slate-900">Ready to validate</p>
                    <p className="text-xs text-slate-500">Zero manual entry</p>
                  </div>
                  <button className="text-xs bg-emerald-600 text-white px-3 py-1 rounded-lg">Validate</button>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <SectionEyebrow icon={<Sparkles className="h-4 w-4" />} label="No data entry" />
            <ScriptHeading className="mt-4 text-3xl sm:text-4xl">
              Just automation
            </ScriptHeading>
            <p className="mt-4 text-lg text-slate-600 leading-relaxed">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <SectionEyebrow icon={<Smartphone className="h-4 w-4" />} label="Mobile companion" />
            <ScriptHeading className="mt-4 text-3xl sm:text-4xl">
              Your finances in your <span className="text-emerald-600">pocket</span>
            </ScriptHeading>
            <p className="mt-4 text-lg text-slate-600 leading-relaxed">
            ...
            <div className="mt-6 space-y-3">
              {["Instant receipt capture", "Real-time expense tracking", "Automatic cloud sync"].map((feature, idx) => (
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
                  ...
                  <div key={idx} className="px-5 py-3 flex items-center justify-between hover:bg-slate-50 transition">
                    <div className="flex items-center gap-3">
                      <div className={`h-1.5 w-1.5 rounded-full ${
                        transaction.status === 'cleared' ? 'bg-emerald-500' : 'bg-yellow-500'
                      }`} />
                      <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {transaction.status === 'cleared' && <CheckCircle2 className="h-3 w-3 text-emerald-600" />}
              ...
              <div className="bg-emerald-50 px-5 py-3 border-t border-emerald-100">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-emerald-800">95% of transactions matched automatically</span>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <SectionEyebrow icon={<PieChart className="h-4 w-4" />} label="Track spending" />
        ...
        <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-6">
          {expenseCategories.map((category, idx) => (
            ...
            >
              <div className={`h-12 w-12 mx-auto rounded-xl bg-${category.color}-100 flex items-center justify-center mb-3`}>
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="text-left">
                <p className="font-semibold text-slate-900">Wim Van den Brande</p>
                <p className="text-sm text-slate-500">Head of Accounting, KPMG</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-slate-900 via-emerald-900 to-cyan-900 px-6 py-16 text-center shadow-2xl sm:px-10">
          ...
          <div className="relative">
            ...
            <p className="mt-6 text-sm text-emerald-200/80">
              Free forever plan available • No credit card required • Instant access
            </p>
          </div>
        </div>
      </section>
