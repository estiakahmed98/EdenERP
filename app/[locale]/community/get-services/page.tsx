...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations("pages.community.metadata.getServices");

  return {
    title: t("title"),
    description: t("description"),
    alternates: getLocaleAlternates("/community/get-services"),
  };
}

export default async function GetServicesPage() {
  const t = await getTranslations("pages.community.hubs.getServices");
