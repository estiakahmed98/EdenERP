...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations("pages.community.metadata.getServicesUpgrades");

  return {
    title: t("title"),
    description: t("description"),
    alternates: getLocaleAlternates("/community/get-services/upgrades"),
  };
}

export default async function UpgradesPage() {
  const t = await getTranslations("pages.community.hubs.getServicesUpgrades");
