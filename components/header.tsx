...
export default function Header() {
  ...
  const appsMegaMenu: MegaMenuColumn[] = [
    ...
    },
    {
      ...
      links: [
        { label: "Social Marketing", href: "/apps/marketing/social-marketing" },
        { label: "Email Marketing", href: "/apps/marketing/email-marketing" },
        { label: "SMS Marketing", href: "/apps/marketing/sms-marketing" },
        { label: "Events", href: "/apps/marketing/events" },
        { label: "Automation", href: "/apps/marketing/automation" },
        { label: "Surveys", href: "/apps/marketing/surveys" },
      ],
    },
    {
      title: "Services",
  ...
  const industriesMegaMenu: MegaMenuColumn[] = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Food", href: "/industries/manufacturing/food" },
        { label: "Brewery", href: "/industries/manufacturing/brewery" },
        { label: "Corporate Gifts", href: "/industries/manufacturing/corporate-gifts" },
      ],
    },
    {
