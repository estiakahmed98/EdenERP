...
export default function NativeAISection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(135deg,#f6f3ff_0%,#eef9ff_45%,#effdfb_100%)] px-6 py-25 text-center">
      ...
      <div className="relative z-10">
        ...
        <div className="reveal shadow-float mx-auto max-w-170 rounded-3xl border border-white bg-white/80 px-6 py-11 backdrop-blur-sm sm:px-12">
