    ...
    <main className="overflow-hidden bg-[linear-gradient(180deg,_#fff_0%,_#faf5ff_18%,_#ffffff_100%)] text-slate-800">
      ...
      <section className="relative isolate">
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 text-center sm:px-6 lg:px-8">
          ...
          <button className="mt-8 inline-flex items-center gap-2 rounded-xl bg-purple-700 px-6 py-3 font-semibold text-white shadow-lg shadow-purple-700/20 transition hover:-translate-y-0.5 hover:bg-purple-800">
            Find Best Match
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-4 md:grid-cols-[1fr_200px_200px]">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 py-3 pl-10 pr-4 text-sm outline-none focus:border-purple-400 focus:ring-1 focus:ring-purple-400"
              />
            </div>
            <select
              value={levelFilter}
              onChange={(e) => setLevelFilter(e.target.value)}
              className="rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-purple-400 focus:ring-1 focus:ring-purple-400"
            >
              {levels.map((level) => (
            ...
            <select className="rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-purple-400 focus:ring-1 focus:ring-purple-400">
          ...
          {filteredPartners.map((partner, index) => (
            ...
            >
              <div className="flex flex-wrap items-center gap-6 md:flex-nowrap">
                {/* Logo */}
                <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-slate-50 to-slate-100 p-3 shadow-md">
                  {partner.logo ? (
                    <Image
                      src={partner.logo}
                      alt={partner.logoAlt}
                ...
                {/* CTA Button */}
                <button className="shrink-0 rounded-xl border border-purple-200 bg-white px-5 py-2.5 text-sm font-semibold text-purple-700 transition hover:bg-purple-50">
                  Contact Partner
                </button>
              </div>
            </div>
        ...
        {/* Stats Banner */}
        <div className="mt-16 rounded-3xl bg-gradient-to-r from-purple-50 to-purple-100 p-8 text-center">
          <div className="mx-auto max-w-2xl">
            <div className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-purple-200">
