...
export const metadata: Metadata = {
  title: "Guest House | EdenERP Industries",
  description:
    "A guest house industry landing page for EdenERP with online booking management, room planning, invoicing, and guest operations.",
};
...
const testimonials = [
  {
    ...
    content:
      "EdenERP helped us achieve our goals while expanding, reducing costs and improving productivity, invoicing, and decision-making thanks to data availability.",
    rating: 5,
  },
  {
          ...
          <div className="max-w-xl space-y-8">
            ...
            <div className="rounded-[2rem] border border-slate-200/80 bg-white/95 p-6 shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              ...
              <p className="text-base leading-7 text-slate-700">
                EdenERP helped us achieve our goals while expanding, reducing costs and
                improving productivity, invoicing, and decision-making thanks to data
                availability.
              </p>
              <div className="mt-6 flex items-center justify-between gap-4 border-t border-slate-100 pt-5">
                <div>
                  <p className="font-semibold text-slate-900">Elena Martinez</p>
                  <p className="text-sm text-slate-500">Owner, Seaside Guest House</p>
                </div>
            ...
            <div className="relative h-[25rem] w-[25rem] overflow-hidden rounded-full border-[14px] border-white bg-[linear-gradient(180deg,_#f0fdfa_0%,_#ffffff_35%,_#fefce8_100%)] shadow-[0_40px_100px_rgba(20,184,166,0.15)]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-white/95 shadow-2xl">
                  <Home className="h-10 w-10 fill-teal-500 text-teal-500" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-6 text-base leading-7 text-slate-600 md:grid-cols-2">
          <div className="rounded-xl bg-white p-5 shadow-sm">
            Create a website using EdenERP's AI-based builder. Showcase your rooms,
        ...
        <div className="mt-12 grid items-start gap-8 md:grid-cols-[1fr_280px]">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xl">
            ...
            <div className="grid grid-cols-3 gap-4">
              {Array.from({ length: 9 }).map((_, index) => (
                <div
                  key={index}
                  className="aspect-[4/3] rounded-xl bg-gradient-to-br from-teal-100 to-slate-200"
                />
              ))}
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xl">
            <div className="mb-4 aspect-[4/3] rounded-xl bg-gradient-to-br from-teal-100 to-amber-100" />
            <h3 className="font-bold text-slate-900">Deluxe Room</h3>
            <p className="mt-1 text-sm text-slate-500">$150.00 / night</p>
            <div className="mt-3 flex items-center gap-1 text-amber-400">
              {Array.from({ length: 5 }).map((_, i) => (
                <Star key={i} className="h-3 w-3 fill-current" />
              ))}
            </div>
            <button className="mt-4 w-full rounded-xl bg-amber-500 py-2 text-sm font-semibold text-white transition hover:bg-amber-600">
              Book Now
            </button>
          </div>
        </div>
              ...
              <div className="space-y-3">
                {Array.from({ length: 6 }).map((_, index) => (
                  <div key={index} className="grid grid-cols-4 gap-3">
                    ...
                    <div className={`h-8 rounded-xl ${index % 2 === 0 ? "bg-teal-100" : "bg-amber-100"}`} />
                    <div className={`h-8 rounded-xl ${index % 3 === 0 ? "bg-purple-100" : "bg-slate-100"}`} />
                    <div className={`h-8 rounded-xl ${index % 2 === 1 ? "bg-teal-100" : "bg-slate-100"}`} />
                  </div>
                ))}
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {Array.from({ length: 6 }).map((_, index) => (
                <div key={index} className="rounded-xl bg-slate-50 p-4">
                  ...
                  <div className="h-12 rounded-xl bg-gradient-to-br from-teal-50 to-slate-100" />
                </div>
              ))}
            </div>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border-t border-slate-100 pt-4">
                  <div className="flex justify-between">
                    ...
                    <div className="h-5 w-20 rounded-full bg-teal-100" />
                  </div>
                </div>
