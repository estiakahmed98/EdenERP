    ...
    <main className="overflow-hidden bg-background text-foreground">
            ...
            <div className="relative h-[25rem] w-[25rem] overflow-hidden rounded-full border-[14px] border-card bg-gradient-to-br from-muted to-background shadow-[0_40px_100px_rgba(0,0,0,0.15)]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-card/95 shadow-2xl">
                  <Beer className="h-10 w-10 fill-primary text-primary" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-primary/5 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div className="order-2 md:order-1 rounded-2xl border border-border bg-card p-5 shadow-xl">
      ...
      <section className="bg-primary/5 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              <div className="mb-4 flex gap-1 text-4xl text-primary">
            ...
            <div className="mx-auto max-w-sm rounded-2xl border border-border bg-card p-6 shadow-xl">
              <div className="mb-5 h-8 rounded-xl bg-muted" />
              <div className="space-y-3">
                {Array.from({ length: 7 }).map((_, index) => (
                  <div key={index} className="flex items-center gap-3 rounded-xl bg-muted/30 p-3">
                    <div className="h-8 w-8 rounded-full bg-card" />
                    <div className="h-3 flex-1 rounded-full bg-muted" />
                    <div className="h-6 w-12 rounded-full bg-primary/20" />
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 md:grid-cols-2">
          <div className="order-2 md:order-1 mx-auto max-w-sm rounded-2xl border border-border bg-card p-8 shadow-xl">
