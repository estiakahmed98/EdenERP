            ...
            <div className="relative h-[25rem] w-[25rem] overflow-hidden rounded-full border-[14px] border-card bg-gradient-to-br from-muted to-background shadow-[0_40px_100px_rgba(0,0,0,0.15)]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-card/95 shadow-2xl">
                  <Calculator className="h-10 w-10 fill-primary text-primary" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 grid items-start gap-8 md:grid-cols-[1fr_320px]">
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-xl">
            ...
            <div className="space-y-3">
              ...
              <div className="mt-4 h-8 rounded-xl bg-primary" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="mx-auto mt-12 grid max-w-5xl gap-8 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-border bg-card p-6 shadow-xl">
              ...
              <div className="space-y-3">
                ...
                <div className="h-10 rounded-xl bg-muted" />
                <div className="h-12 rounded-xl bg-primary" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div className="mx-auto max-w-md rounded-2xl border border-border bg-card p-8 shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between">
                <div className="h-4 w-16 rounded-full bg-destructive/20" />
                <div className="h-4 w-14 rounded-full bg-destructive/20" />
              </div>
              <div className="flex justify-between">
                <div className="h-4 w-20 rounded-full bg-accent/20" />
                <div className="h-4 w-18 rounded-full bg-accent/20" />
              </div>
